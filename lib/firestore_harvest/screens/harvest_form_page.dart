          ...
          child: ListView(
            ...
            children: [
              ...
              Container(
                ...
                padding: EdgeInsets.only(left: 10),
                child: Text(
                  'Valor de venda do Lote/Unidade',
                  style: TextStyle(
                    fontSize: 18.0,
                    fontWeight: FontWeight.bold,
                    color: Colors.grey[900],
                ...
                child: MyTextFieldWrapper(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Por favor, informe o valor de venda';
                    }
                    return null;
                  },
                ),
              ...
              SizedBox(
                ...
                child: MyTextFieldWrapper(
                  hintText: 'Número',
                  controller: _quantityOfLabels,
                  obscureText: false,
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Por favor, informe a quantidade de etiquetas';
                    }
                    return null;
                  },
                ),
              ...
              SizedBox(
                ...
                child: MyTextFieldWrapper(
                  hintText: 'Número',
                  controller: _quantityLabel,
                  obscureText: false,
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Por favor, informe a quantidade que irá na etiqueta';
                    }
                    return null;
                  },
                ),
